...
public class ExamPeriodServiceImpl implements ExamPeriodService {
    ...
    public List<String> validateExamPeriod(List<ExamPeriod> examPeriodList, ExamPeriod currentExamPeriod) {
        ...
        for (ExamPeriod epDate : examPeriodList) {
            if ((currentExamPeriod.getStartDate().isBefore(epDate.getEndDate()) || currentExamPeriod.getStartDate().isEqual(epDate.getEndDate())) &&
                    (currentExamPeriod.getEndDate().isEqual(epDate.getStartDate()) || currentExamPeriod.getEndDate().isAfter(epDate.getStartDate()))) {
